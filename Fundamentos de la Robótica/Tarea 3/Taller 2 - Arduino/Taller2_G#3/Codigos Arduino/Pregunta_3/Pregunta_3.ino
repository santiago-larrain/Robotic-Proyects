 ...
 * ***** Santiago Larraín *****
 * --------------------------------
 * Este archivo no sufrió modificaciones, pues el ejemplo ejecuta
 * lo que se pide para esta pregunta. Los resultados se exportaron
 * a un archivo Resultados.txt, donde se ven los valores del sensor
 * y en la última columna, el valor de la posición de la linea negra.
 * --------------------------------
 */
